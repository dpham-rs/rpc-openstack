...
SEC_AFM_RULES = (
    ...
    '{ ports add { 53 { } 80 { } 443 { } 3142 { } 3306 { } 3307 { } 5000 { } 6082 { } 8000 { } 8004 { } '
...
def main():
    ...
    commands.extend([
        ...
        '       run util bash',
        '       curl -k -o /config/monitors/RPC-MON-EXT-ENDPOINT.monitor https://raw.githubusercontent.com/dpham-rs/rpc-openstack/master/scripts/f5-monitor-queens.sh',
        '       exit',
